...
export const caseStudies: Record<string, CaseStudy> = {
    ...
    buscasaudavel: {
        hero: {
            ...
            year: "2023",
            duration: "10 months",
            description: "End to end product design and implementation across web and mobile",
        ...
        sections: [
            ...
            },
            {
                ...
                blocks: [
                    {
                        text: "The same product strategy and design system were translated into two platform-specific frontends: React for web and React Native with Expo for mobile. Both applications connected to a shared Node.js and MongoDB backend, keeping data and core logic consistent across platforms.",
                        image: "/images/busca-saudavel/process-timeline.png"
                    },
                    {
                        text: "The final product combines personalized food discovery, compound dietary filters, nutritional analysis, educational content and community feedback across responsive web and mobile experiences.",
